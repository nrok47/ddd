...
for number in numbers:
    ...
    if "พฤศจิกายน" in text and "2566" in text:
...
#chang1 --<
col_letter = 'E'  # The column letter you want to find the last row for
...
cell_range = f"E{last_row_ee}" #chang2 --<
...
# Find the last row in the column
#chang1 --<
col_letter = 'CO'  # The column letter you want to find the last row for
#column_values = worksheet.col_values(ord(col_letter.lower()) - 96)  # Convert column letter to column index
...
#print(last_row_ee)
# Define the cell range for column E in the last row
cell_range_nn = f"CO{last_row_ee}" #chang2 --<
