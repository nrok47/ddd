...
#chang1 --<
col_letter = 'AC'  # The column letter you want to find the last row for
#column_index = gspread.utils.a1_to_column_index(col_letter)
#column_values = worksheet.col_values(column_index)  # Convert column letter to column index
...
cell_range = f"AC{last_row_ee}" #chang2 --<
